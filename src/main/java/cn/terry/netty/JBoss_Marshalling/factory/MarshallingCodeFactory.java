...
public class MarshallingCodeFactory {
	...
	public static MarshallingDecoder buildMarshallingDecoder(){
		...
		UnmarshallerProvider unmarshallerProvider = new DefaultUnmarshallerProvider(marshallingFactory, configuartion);
	...
	public static MarshallingEncoder buildMarshallingEncoder(){
		...
		MarshallerProvider marshallerProvider = new DefaultMarshallerProvider(marshallingFactory, configuartion);
